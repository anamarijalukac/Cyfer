...
function RegUdr(props) {
  ...
  const [form, setForm] = React.useState({username: '', oib: '', name:'',location:'', address:'', password:'', repeatPassword:''});
  ...
  function onSubmit(e){
    ...
    if(form.password !== form.repeatPassword){
      setForm({username: '', oib: '', name:'',location:'', address:'', password:'', repeatPassword:''});
    ...
    <div class="container">
      <form onSubmit = {onSubmit}>
        ...
        <div className="container">
          ...
          <label>Lokacija udruge: </label>
          <input type="text" name='location' placeholder="Upiši lokaciju udruge" onChange = {onChange} value = {form.location}  required/>
