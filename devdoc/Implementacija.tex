\chapter{Implementacija i korisničko sučelje}
		...
		\section{Ispitivanje programskog rješenja}
			...
			\begin{figure}[H]
				\centerline{
			 	\includegraphics[scale=0.75]{slike/shelter1.PNG}} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			 	\centering
			 \end{figure}
		 \begin{figure}[H]
		 	\includegraphics[scale=0.65]{slike/shelter2.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
		 	\centering
		 \end{figure}
