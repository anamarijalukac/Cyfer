\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\section*{Tablica aktivnosti}					
			...
			\begin{longtabu} to \textwidth {|X[7, l]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|}
				...
				Upravljanje projektom 		& 3 &  & 0  &  &  & 1 & \\ \hline
				Opis projektnog zadatka 	& 3 &  & 0 &  &  & 0 & \\ \hline
				
				Funkcionalni zahtjevi       & 1.5 &  & 0 &  &  & 0 &  \\ \hline
				Opis pojedinih obrazaca 	& 3 &  & 0 &  &  & 0.5 &  \\ \hline
				Dijagram obrazaca 			&1.5  &  & 0  &  &  & 0 &  \\ \hline
				Sekvencijski dijagrami 		& 3 &  &  0&  &  & 0.5 &  \\ \hline
				Opis ostalih zahtjeva 		& 0.5 &  & 0 &  &  & 0 &  \\ \hline
